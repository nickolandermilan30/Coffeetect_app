...
public class History3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history3);  // I-update ang layout na tukoy para sa History3
        ...
        List<SavedResult> savedResults = SavedResultsManager.getHistory3List();  // Ito ay maaaring pagbabago depende sa iyong implementation
        ...
        if (SavedResultsManager.getHistory3List().size() < 10) {  // Ito ay maaaring pagbabago depende sa iyong implementation
        ...
        recommendationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecommendationClickable) { // Check if button is clickable
                    Intent intent = new Intent(History3.this, RecommendationActivity.class);
        ...
        clearResultsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(History3.this);
                ...
                builder.setPositiveButton("Clear", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        SavedResultsManager.clearHistory3Results();  // Ito ay maaaring pagbabago depende sa iyong implementation

                        // Refresh the RecyclerView
                        savedResultsList.clear();
                        RecyclerView recyclerView = findViewById(R.id.recyclerView);
                        SavedResultsAdapter adapter = new SavedResultsAdapter(savedResultsList);
                        recyclerView.setLayoutManager(new LinearLayoutManager(History3.this));
                        recyclerView.setAdapter(adapter);
