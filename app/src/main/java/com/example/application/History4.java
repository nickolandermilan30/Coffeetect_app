...
public class History4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history4);  // I-update ang layout na tukoy para sa History3
        ...
        List<SavedResult> savedResults = SavedResultsManager.getHistory4List();  // Ito ay maaaring pagbabago depende sa iyong implementation
        ...
        if (SavedResultsManager.getHistory4List().size() < 10) {  // Ito ay maaaring pagbabago depende sa iyong implementation
        ...
        clearResultsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(History4.this);
                ...
                builder.setPositiveButton("Clear", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        SavedResultsManager.clearHistory4Results();  // Ito ay maaaring pagbabago depende sa iyong implementation

                        // Refresh the RecyclerView
                        savedResultsList.clear();
                        RecyclerView recyclerView = findViewById(R.id.recyclerView);
                        SavedResultsAdapter adapter = new SavedResultsAdapter(savedResultsList);
                        recyclerView.setLayoutManager(new LinearLayoutManager(History4.this));
                        recyclerView.setAdapter(adapter);
