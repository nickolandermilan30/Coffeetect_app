...
public class History6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history6);  // I-update ang layout na tukoy para sa History3
        ...
        recommendationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecommendationClickable) { // Check if button is clickable
                    Intent intent = new Intent(History6.this, RecommendationActivity.class);
        ...
        clearResultsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(History6.this);
                ...
                builder.setPositiveButton("Clear", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(History6.this));
                        recyclerView.setAdapter(adapter);
