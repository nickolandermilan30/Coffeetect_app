...
public class History7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history7);  // I-update ang layout na tukoy para sa History3
        ...
        recommendationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecommendationClickable) { // Check if button is clickable
                    Intent intent = new Intent(History7.this, RecommendationActivity.class);
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Clear", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(History7.this));
                        recyclerView.setAdapter(adapter);
