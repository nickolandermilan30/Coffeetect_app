...
public class History9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history9);  // I-update ang layout na tukoy para sa History3
        ...
        recommendationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecommendationClickable) { // Check if button is clickable
                    Intent intent = new Intent(History9.this, RecommendationActivity.class);
        ...
        clearResultsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(History9.this);
                ...
                builder.setPositiveButton("Clear", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(History9.this));
                        recyclerView.setAdapter(adapter);
